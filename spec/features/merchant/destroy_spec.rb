...
RSpec.describe 'Destroy Existing Merchant' do
  describe 'As a visitor' do
    before :each do
      ...
      @user_1 = User.create!(email: "123@gmail.com", password_digest: "password", name: "Do do Mace", address: "456 Main St.", city: "Denver", state: "CO", zip: 80220, role: 1)
      @order = @user_1.orders.create(name: 'Molly', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
